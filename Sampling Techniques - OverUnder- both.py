...
plt.ylabel("Values")
plt.xlabel("Class")
plt.title("Class Distribution of the Dataset - Over-Under Sample")
plt.show()
...
for i in range(1, 11):
    for j in range(1, 6):
        model = RandomForestClassifier(n_estimators=i, max_depth=j, criterion="entropy", random_state=0).fit(X,
                                                                                                             Y)
